...
const UserInfo = () => {
  ...
  return (
    <div className="p-5 flex items-center justify-between sm:flex-col  md:flex-row sm:items-start">
      <div className="flex items-center gap-3 sm:gap-1">
        {<img src={userData.url} alt="" className="w-16 h-16   rounded-full" />}
        <h2 className="md:text-xl mx-4 sm:text-base xs:text-sm">{userData.username}</h2>
      </div>
